...
function Disable-MGreenEthernetAndEEE {
    try {
        ...
        if ($adapterProperties | Where-Object { $_.RegistryKeyword -eq "EnableGreenEthernet" }) {
            ...
            Set-NetAdapterAdvancedProperty -Name "Ethernet" -RegistryKeyword "EnableGreenEthernet" -DisplayValue "Disabled" | Out-Null
        }
        else {
        ...
        if ($adapterProperties | Where-Object { $_.RegistryKeyword -eq "EEE" }) {
            ...
            Set-NetAdapterAdvancedProperty -Name "Ethernet" -RegistryKeyword "EEE" -DisplayValue "Disabled" | Out-Null
        }
        else {
